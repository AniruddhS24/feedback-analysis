...
def main():
    ...
    ext = HeuristicExtractor(fts, rationalelengthprop=0.1)
...
if __name__ == '__main__':
    main()
    #ar = torch.tensor([[1,2,3],[4,6,2]], dtype=torch.float)

    #train pred on sst with 5 labels, see if it agrees with supp (some sort of weighting function of both outputs)